...
class LifestyleSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for i in range(18):
            ...
            link = response.xpath("//div[@class='nation']/div[@class='articles']/div[@class='snaps']/a/@href")[
                i].extract()
            s = response.xpath("//div[@class='nation']/div[@class='articles']/div[@class='snaps']/a/noscript")[
                i].extract()
            l = s.split('"')
            img = l[5]
            l = []
