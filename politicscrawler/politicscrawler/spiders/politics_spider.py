...
class PoliticsSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for i in range(10):
            ...
            title = response.xpath("//div[@class='css-apvlfc']/ol/li/div/div/a/h2/text()")[i].extract()
            link = "https://www.nytimes.com" + response.xpath("//div[@class='css-apvlfc']/ol/li/div/div/a/@href")[
                i].extract()
            img = response.xpath("//div[@class='css-apvlfc']/ol/li/div/div/a/div[@class='css-0 "
                                 "e1y9711p0']/figure/@itemid")[
                i].extract()
            items["title"] = title
            items["image"] = img
            items["url"] = link
    ...
    def parse(self, response):
        for i in range(10):
            ...
            link = "https://economictimes.indiatimes.com" + \
                   response.xpath("//section[@id='bottomContent']/section/div/a/@href")[i].extract()
